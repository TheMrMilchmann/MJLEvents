 ...
 * all access. This class is fully interoperable with {@code Hashtable} in
...
public final class ConcurrentWeakHashMap<K, V> extends AbstractMap<K, V>
    ...
    @Nullable transient Set<Map.Entry<K, V>> entrySet;
    ...
    static final class HashEntry<K, V> {
        ...
        final int hash;
        @Nullable volatile V value;
        @Nullable final HashEntry<K, V> next;

        HashEntry(K key, int hash, @Nullable HashEntry<K, V> next, @Nullable V value, ReferenceQueue<K> refQueue) {
    ...
    static final class Segment<K, V> extends ReentrantLock implements Serializable {
         ...
         */
        @Nullable transient volatile HashEntry<K, V>[] table;
         ...
         */
        @Nullable transient volatile ReferenceQueue<K> refQueue;
         ...
         */
        @Nullable
        V remove(Object key, int hash, @Nullable Object value, boolean weakRemove) {
            lock();
            try {
                if(!weakRemove)
                    removeStale();
    ...
    abstract class HashIterator {
        ...
        int nextTableIndex;
        @Nullable HashEntry<K, V>[] currentTable;
        @Nullable HashEntry<K, V> nextEntry;
        @Nullable HashEntry<K, V> lastReturned;
        @Nullable K currentKey; // Strong reference to weak key (prevents gc)
    ...
    final class WriteThroughEntry extends SimpleEntry<K, V> {
         ...
         */
        public V setValue(V value) {
            V v = super.setValue(Objects.requireNonNull(value));
    ...
    /**
     * Save the state of the {@code ConcurrentWeakHashMap} instance to a
    ...
    /**
     * Reconstitute the {@code ConcurrentWeakHashMap} instance from a
